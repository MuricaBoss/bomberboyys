...
class BaseDefenseScene_Advanced extends Phaser.Scene {
  ...
  updateRtsCamera(delta: number) {
    ...
    const targetVX = hasTouchScrollIntent ? this.touchGestureScrollVX : 0;
    const targetVY = hasTouchScrollIntent ? this.touchGestureScrollVY : 0;
    const response = hasTouchScrollIntent ? 8 : 11;
