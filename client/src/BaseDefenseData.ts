...
export class BaseDefenseScene_Data extends Phaser.Scene {
  ...
  // Build 525: Tweakable overlap avoidance parameters
  overlapPushStrength = 8.0;
  overlapPushDistanceScale = 0.92;
  ...
  unitUiGraphics: Phaser.GameObjects.Graphics | null = null;
  unitShadowGraphics: Phaser.GameObjects.Graphics | null = null;
  ...
  tilemapLayer: Phaser.Tilemaps.TilemapLayer | null = null;
  ...
  unitCountsText!: Phaser.GameObjects.Text;
  soldierCount = 0;
  tankCount = 0;
  lastMoveLeaderCount = 0;
  lastMoveFollowerCount = 0;
  lastMoveSubgroupSize = 0;
  ...
  sharedMovePathCache = new Map<string, { cells: { x: number; y: number }[]; cost: number; updatedAt: number }>();
