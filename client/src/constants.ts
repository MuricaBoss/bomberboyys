...
export const RTS_SOLDIER_SHOOT_FRAME_COLS = 7; // Build 264 Fix: Matched to run.png and rescale_units.sh script (7 columns)
...
export const RTS_SOLDIER_DISPLAY_SIZE = 32;
export const RTS_SOLDIER_ORIGIN_Y = 0.84;
export const RTS_PLAYER_SOLDIER_DISPLAY_SIZE = 32;
...
export const FOG_UPDATE_MS = 500;
